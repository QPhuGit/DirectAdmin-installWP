...
wget -O custom_package_items.conf https://raw.githubusercontent.com/QPhuGit/DirectAdmin-installWP/main/data/custom_package_items.conf
...
wget -O custom_domain_items.conf https://raw.githubusercontent.com/QPhuGit/DirectAdmin-installWP/main/data/custom_domain_items.conf
...
wget -O domain_create_post.sh https://raw.githubusercontent.com/QPhuGit/DirectAdmin-installWP/main/scripts/domain_create_post.sh
...
wget -O subdomain_create_post.sh https://raw.githubusercontent.com/QPhuGit/DirectAdmin-installWP/main/scripts/subdomain_create_post.sh
